...
def _upload_and_wait(client: genai.Client, file_path: str, timeout: int = 300):
    """Upload file lên Files API và chờ tới khi ACTIVE."""
...
def summarize_meeting(file_path: str) -> dict:
    """Nhận đường dẫn file audio -> dict biên bản theo MeetingSummary."""
    client = _client()
